...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "fastblock.py"

        #Name of program
        self.project_name = "Block Game"

        #Project url
        self.project_url = "https://github.com/CelineLoyola21/fastblock"
        ...
        #Auhor of program
        self.author_name = "Me"
        self.author_email = "celineloyola21@gmail.com"
        self.copyright = "Copyright (c) 2015."

        #Description
        self.project_description = "This is a simple block game. Inspired by the codes of IAN MALLETT from (pygame.org)"
